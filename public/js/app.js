...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    changeEstado: function changeEstado(todo) {
      var _this4 = this;
  ...
  computed: {
    filteresTodos: function filteresTodos() {
      var _this5 = this;

      return this.todos.filter(function (todo) {
        return todo.titulo.toLowerCase().includes(_this5.n.toLowerCase());
      });
    }
  }
});
  ...
  return _c(
    ...
    [
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.todo.titulo,
                  expression: "todo.titulo"
                }
              ],
              staticClass: "form-control mb-2",
              attrs: { type: "text", placeholder: "Que vamos a hacer hoy?" },
              domProps: { value: _vm.todo.titulo },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.todo, "titulo", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.todo.descripcion,
                  expression: "todo.descripcion"
                }
              ],
              staticClass: "form-control mb-2",
              attrs: {
                type: "text",
                placeholder: "Informacion Extra sobre la actividad"
              },
              domProps: { value: _vm.todo.descripcion },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.todo, "descripcion", $event.target.value)
                }
              }
            })
          ]),
      ...
      _c("ul", { staticClass: "pagination" }, [
              ...
              "a",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.fetchTodos(_vm.pagination.prev_page_url)
                  }
                }
              },
              [_vm._v("Anterior")]
          ...
          [
            _c(
              "a",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.fetchTodos(_vm.pagination.next_page_url)
                  }
                }
              },
              [_vm._v("Siguiente")]
        ...
        _c("input", {
          directives: [
            { name: "model", rawName: "v-model", value: _vm.n, expression: "n" }
          ],
          staticClass: " ml-3 pa-2",
          attrs: { type: "text", placeholder: "Buscas algo?" },
        ...
        _vm._v(" "),
        _c("li", { staticClass: " ml-3 page-item" }, [
          _c(
            "button",
            {
              staticClass: "page-link",
      ...
      _vm._v(" "),
      _vm._l(_vm.filteresTodos, function(todo) {
        return _c(
          "div",
          {
            key: todo.id,
            staticClass: "visible card card-body mb-2 row",
            class: [{ noVisible: _vm.visible == todo.estado }]
          },
          [
            _c("div", { staticClass: "row container" }, [
              _c("div", { staticClass: "col-10" }, [
                _c("h3", [_vm._v(_vm._s(todo.titulo))]),
                _vm._v(" "),
                _c("p", [_vm._v(_vm._s(todo.descripcion))])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "mb-2 col-2 text-right" }, [
                todo.estado == false
                  ? _c(
                      "button",
                      {
...
Vue.component('todos', _components_Todos_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
__webpack_require__(/*! C:\xampp\htdocs\todo\todo-back\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\todo\todo-back\resources\sass\app.scss */"./resources/sass/app.scss");
